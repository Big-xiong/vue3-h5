<template>
  <van-popup v-model:show="visible" lock-scroll overlay position="top" @close="handleClose" class="lang-popup-wrap"
    overlay-class="lang-overlay" teleport="body">
    <div class="lang-wrap" :class="{ 'has-install': app?.showDownload }">
      <div class="lang-wrap-item" v-for="(item, key) in langList" :key="key" @click="selectLang(item)">
