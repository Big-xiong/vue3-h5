...
const allImages = import.meta.glob(`/src/assets/native-sports/{images,dark}/**/*.{png,jpg,svg,gif,webp}`);
const currentImages = import.meta.glob(`/src/current_project/assets/native-sports/**/*.{png,jpg,svg,gif,webp}`) || {};
